...
export default function BlogSection() {
  const scopeRef = useGsap<HTMLElement>(() => {
    gsap.fromTo(
      ...
      { opacity: 0, y: 22 },
      {
        ...
        stagger: 0.12,
        ease: "power3.out",
        scrollTrigger: { trigger: ".blog-content", start: "top 82%" },
      }
    );
    gsap.fromTo(
      ".blog-svg path",
      { strokeDashoffset: 60 },
      {
        ...
        duration: 1.6,
        ease: "power2.out",
        scrollTrigger: { trigger: ".blog-svg", start: "top 85%" },
      }
    );
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="blog-content relative mx-auto flex max-w-2xl flex-col items-center px-6 text-center md:px-12">
        <div className="blog-svg mb-8">
